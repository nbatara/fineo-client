...
```
$ java -cp tools-1.1.2-SNAPSHOT-exec.jar io.fineo.client.tools.Schema \
  --api-key <your api key> \
  --username <your email> --password <your password> \
...
```
$ java -cp tools-1.1.2-SNAPSHOT-exec.jar;my-company-files.jar io.fineo.client.tools.Stream \
  --api-key <your api key> \
  --username <your email> --password <your password> \
  --type metric \
  --field field.value
...
```
$  java -cp tools-1.1.2-SNAPSHOT-exec.jar;my-company-files.jar io.fineo.client.tools.TimestampValidation \
    --pattern <pattern> \
    --value <column value>
```
...
```
$ java -jar tools-1.1.2-SNAPSHOT-jdbc.jar \
    --api-key <your api key> \
    --username <your email> --password <your password> \
...
[here]: http://maven.fineo.io/release/io/fineo/client/tools/1.1.2-SNAPSHOT/tools-1.1.2-SNAPSHOT-exec.jar
[own jar]: http://maven.fineo.io/release/io/fineo/client/tools/1.1.2-SNAPSHOT/tools-1.1.2-SNAPSHOT-jdbc.jar
